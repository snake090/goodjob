...
<%
	...
	boolean backList = (session.getAttribute("back") == null)? false : (boolean)session.getAttribute("back");
	if(order_view == null || order_view_items == null) request.getRequestDispatcher("errorAccess.jsp").forward(request, response);
	int sum_quantity = 0;
	int sum_price = 0;
%>
...
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  <o:Author>Taihei Yoshimoto</o:Author>
  <o:LastAuthor>Taihei Yoshimoto</o:LastAuthor>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0 align=left
 ...
 <tr style='mso-yfti-irow:15;height:19.05pt'>
  ...
  &nbsp;
  <% if(order_view.getPayment_category() == 1) out.println(order_view.getDivision()); %><%-- 分割回数 --%>
  &nbsp;
 ...
 <tr style='mso-yfti-irow:17;height:19.05pt'>
  ...
  margin;mso-element-left:center;mso-element-top:49.5pt;mso-height-rule:exactly'><span
  lang=EN-US style='font-size:6.0pt;mso-bidi-font-size:11.0pt'>
  <%if(order_view.getPayment_category() == 2) out.println(order_view.getFrom_bank());  %><%-- 振込元銀行 --%>
  <o:p></o:p></span></p>
  </td>
 ...
 <tr style='mso-yfti-irow:18;height:19.05pt'>
  ...
  "ＭＳ 明朝";mso-fareast-theme-font:minor-fareast;mso-hansi-font-family:Century;
  mso-hansi-theme-font:minor-latin'>
  <% if(order_view.getPayment_category() == 1) {%>
 ...
 <tr style='mso-yfti-irow:21;mso-yfti-lastrow:yes;height:19.05pt'>
  ...
  49.5pt;mso-height-rule:exactly'>
	...
	<% if(backList == true) { %>
		<a href="orderview/ordersearchresult.jsp" id="print" class="btn btn-warning">戻る</a>
	<% } %>
	<a href="orderview/clear.jsp" id="print" class="btn btn-warning">メインメニューに戻る</a>
